...
<div id="Form">
      <form action="conect.php" method="POST" >
        ...
        <h6 >Using Resilience Account</h6>
        ...
        <input type="password" name="password" placeholder="Enter your password" id="ep" autocapitalize="none" autocorrect="off" style="border-color: #200122; padding:8px; border-radius: 10px;width:250px; " />
        <br><br>
