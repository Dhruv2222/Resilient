...
<div id="Form">
      <form method="POST" >
<!--        <h4 style="font-weight: bold;">Your</h4>-->
          <h4 id="main_heading">Your Resilient Resume</h4><br>
<!--          <h4 style="font-weight: bold;">Resume</h4><br>-->
          
        <input type="text" value="<?php echo $_SESSION["stname"]?>"  name= "name" placeholder="Name" id="ep" autocorrect="off" style="border-color: #200122; padding:8px;border-radius: 10px;width:300px; color: blue;" />
          <br><br>
        <input type="text" value="<?php echo $_SESSION["stdob"]?>" name="dob" placeholder="25th May 2000" id="ep" autocorrect="off" style="border-color: #200122; padding:8px;border-radius: 10px;width:300px; color: blue;" />
          <br><br>
        <input type="text" value="<?php echo $_SESSION["stcontact"]?>" name="contact" placeholder="9856425135" id="ep" autocorrect="off" style="border-color: #200122; padding:8px;border-radius: 10px;width:300px; color: blue;" />
          <br><br>
        <input type="text" value="<?php echo $_SESSION["stclg"]?>" name="clgname" placeholder="KJSCE" id="ep" autocorrect="off" style="border-color: #200122; padding:8px;border-radius: 10px;width:300px; color: blue;" />
          <br><br>
        <input type="text" value="<?php echo $_SESSION["stdegree"]?>" name="degree" placeholder="Bachelor of Tecnology" id="ep" autocorrect="off" style="border-color: #200122; padding:8px;border-radius: 10px;width:300px; color: blue;" />
          <br><br>
        <input type="text" value="<?php echo $_SESSION["stbranch"]?>" name="branch" placeholder="Information Technology" id="ep" autocorrect="off" style="border-color: #200122; padding:8px;border-radius: 10px;width:300px; color: blue;" />
          <br><br>
