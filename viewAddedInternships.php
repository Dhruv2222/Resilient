...
<br>
<br>
<center><h1 style="" id="sub_heading"> Your Offered Internships</h1></center>
<?php
$uidd = $_SESSION["uid"];
$conn = mysqli_connect('localhost','root','','resilient');
$sql2="SELECT * FROM internships WHERE uid='$uidd'";
...
<div class="card bg-light mb-3" style="max-width: 50rem; ">
  <div class="card-header"><?php echo $post; ?></div>
  <div class="card-body">
    <h5 class="card-title"><?php echo $organization; ?></h5><br>
      ...
      <div class="card-text row">
        <div class="col"><?php echo $stipend; ?></div>
        <div class="col"><?php echo $interntype; ?></div>
        <div class="col"><?php echo $duration; ?></div>

      </div>
      <hr>
  <?php  echo'<a href="internshipDetails.php?internshipid='.$internshipid.'" class="btn btn-primary">More details</a>';?> 
