...
<div class="card bg-light mb-3" style="max-width: 50rem; ">
  <div class="card-header"><?php echo $row["post"]; ?></div>
  <div class="card-body">
    <h5 class="card-title"><?php echo $name; ?></h5><br>
      ...
      <div class="card-text row">
        <div class="col"><?php echo $row4["degreeclg"]; ?></div>
      ...
      <div class="row">
        ...
        if ($row3["status"]==1) {
          echo '<div class="col">
          <form method="post"> <button class="btn btn-success" type="submit" name="submit" disabled>Hired</button></form>
          </div>';
        } else{
          echo '<div class="col">
          <form method="post"> <button class="btn btn-success" type="submit" name="submit">Hire</button></form>
          </div>';
        }?>
...
<!--Card code ends here-->
  ...
  if ($_SERVER['REQUEST_METHOD']='POST') {
    ...
    $query="UPDATE applicants SET status=1 WHERE uid='$uuid'";
